...
[5. lvalue_rvalue](#5-lvalue_rvalue)
[6. std::move-std::forward](#6-std::move-std::forward)
[7. variadic_template](#7-variadic_template)
...
+ std::move prototype:
    ...
    1.根据模板推断规则，确定T的类型为string；
    2.typename remove_reference::type &&的结果是string &&
    3.move函数的参数类型为string &&
    ```
