...
+ std::move prototype:
    ...
    example: 
    std::move(string("hello"))调用解std::move_std::forward 
    std::move_std::forward ，确定T的类型为std::move_std::forward 
    std::move_std::forward std::move_std::forward type &&的结果是std::move_std::forward 
    std::move_std::forward 型为string &&
    std::move_std::forward 
...
int main(){
    ...
    //find elements' count that are less than 10
